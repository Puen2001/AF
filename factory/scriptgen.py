...
ANGLES = {
    "curiosity-fact": "เริ่มจากข้อเท็จจริงน่าทึ่ง/เซอร์ไพรส์เกี่ยวกับของชิ้นนี้หรือหลักการเบื้องหลัง "
                      "(แนวสาระน่ารู้ TOGE) เล่าให้อยากรู้ต่อ แล้วค่อยโยงมาที่ของแบบธรรมชาติ ไม่ขาย",

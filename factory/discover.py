...
TRIAGE_PROMPT = """คุณคือ content strategist + affiliate buyer วิดีโอสั้นสายแกดเจ็ตไทย
ให้คะแนนสินค้าแต่ละชิ้น 1-10 โดยรวม 4 ด้าน (เลือกเฉพาะของดี ขายได้ กำลังฮิต):
- คุณภาพ/รีวิว: รีวิวดี ไม่ค่อยมีปัญหา คนใช้จริงชม
- กระแส/เทรนด์: กำลังมาแรง คนพูดถึง/ค้นหาเยอะช่วงนี้
- ยอดขาย: ขายดี เป็น best-seller หมวดนี้
- โอกาสปิดการขาย: ราคากดซื้อง่าย (สาย impulse ~79-499 บาท), แก้ปัญหาจริง, คนอยากได้เอง

{listing}

ให้คะแนนต่ำกับของรีวิวแย่/ราคาสูงเกินกดซื้อ/ไม่มีกระแส
